...
$autoLoader = 'dts-file-transfer-autoloader.php';
...
$packager->createZip(__DIR__ . '/artifacts/dts-file-transfer.zip');
$packager->createPhar(__DIR__ . '/artifacts/dts-file-transfer.phar', null, $autoLoader);
